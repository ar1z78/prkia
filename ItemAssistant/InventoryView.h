...
//		COMMAND_RANGE_HANDLER(ID_REFRESH_1S, ID_REFRESH_10S, OnSetRefreshTime)
	...
	LRESULT OnShowInfo(WORD, WORD, HWND, BOOL&);
...
private:
    ...
    std::shared_ptr<AccountRootTreeViewItem> m_rootNode;
	...
	aoia::SignalConnection m_addSignalConnection;
	aoia::SignalConnection m_removeSignalConnection;
	aoia::SignalConnection m_clearSignalConnection;
	aoia::SignalConnection m_updateSignalConnection;
