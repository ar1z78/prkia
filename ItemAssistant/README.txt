--------------------------------------------------------------------------------
                         ...
                         PROJECT RUBI-KA ITEM ASSISTANT
                   https://users.math.uoc.gr/~ar1z/prkia.html
...
application with the option called -db.
   
Example: ItemAssistant.exe -db c:\MyItemAssistant.db
...
Change Log:
===========
Version 2.0.0.0                                      Release Date: 24/04/2026
	* Cleaned up the code and moved all extra libraries into the main project.
	* Removed the non working recipe code.
	* Removed online help and made it local.
	* Added support for pocket bosses symbiant loot tables.
...
Version 1.5.6.1                                      Release Date: 3/04/2026
    * Fixed Sell Prices Calculations. In Inventory Menu -> Seller Stats, Put
	  your seller's CL skill, select Omni if your seller can sell at OmniTek 
	  or at Miiir Fashion store at Newland or Trader if you have one. Thanks 
	  Shimazu!

Version 1.5.6                                        Release Date: 2/04/2026
    * Inventory actions now show the checkmarks in Inventory Menu
    * Added back the online help (needs some improvements)
    * Added Sell Price to the List. Check Inventory Menu. This shows you if 
      the item you looted is trash or not.
    * General code cleanup.

Version 1.5.5                                        Release Date: 31/03/2026
	* Added menu items for Inventory actions (Linux bugfixes)
	* Added functionality to view item details on tinkeringidiot's web site.
	* Added functionality to view item details on aogalaxy's web site.
    * General code cleanup.
	* Fixed bug of automatic location of Anarchy Online prefs folder
	* Removed boost::filesystem because it crashed in windows 10/11
	* Merged ItemAssistantCore.dll with the main file.
	* Added support for Project RK Database instead of AO .idx and .dat files
	* Updated project to use Boost 1.68.0
    * Updated project to use WTL v10.0.10320
